      ...
      <Dialog open={showIosHelp} onOpenChange={setShowIosHelp}>
        <DialogContent className="w-[calc(100%-1rem)] border-border-strong bg-surface text-foreground sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              iOS uses Safari&apos;s Share menu instead of the Android-style install prompt.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3 text-sm text-muted-foreground">
            <div className="flex items-center gap-3 rounded-xl border border-border/60 bg-muted/30 p-3">
              ...
              <span>1. Open TutorLedger in Safari and tap <strong className="text-foreground">Share</strong>.</span>
            </div>
            <div className="flex items-center gap-3 rounded-xl border border-border/60 bg-muted/30 p-3">
