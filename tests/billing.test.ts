...
test("monthly billing uses explicit enrollment month when activity history is empty", () => {
  assert.equal(
...
test("billing does not accrue before an explicit future billing start month", () => {
  assert.equal(
